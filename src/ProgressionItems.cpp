...
class ProgressionItems : public WorldScript
{
    public:
        ProgressionItems() : WorldScript("ProgressionItems") {}

        void OnBeforeItemTemplateQueried(std::string& query) override
        {
            query = Acore::StringFormat("SELECT entry, class, subclass, SoundOverrideSubclass, name, displayid, Quality, Flags, FlagsExtra, BuyCount, BuyPrice, SellPrice, InventoryType, "
                                        ...
                                        "FoodType, minMoneyLoot, maxMoneyLoot, flagsCustom FROM item_template a "
